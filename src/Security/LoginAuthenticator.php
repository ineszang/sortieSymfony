...
class LoginAuthenticator extends AbstractLoginFormAuthenticator
{
    ...
    public function authenticate(Request $request): Passport
    {
        ...
        // Vérification personnalisée : par exemple, un service pour vérifier si l'utilisateur est actif
        $participant = $this->participantRepository->findOneByPseudo($username);
